...
// Framework setting
#define _DIST_TARGET 230    // [2635] 목표하는 위치
...
#define _DUTY_NEU 1380    // [3070] 레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 1600                //[3062] 서보의 최대각도의 microseconds의 값
